...
export CUR_LEARN_VERSION=ultra
export BB_VINAME=BBLEARN_ULTRA
export BBHOME=/usr/local/ultra/blackboard
...
export BB_DEVELOPER_CONFIG=/Users/jeggert/learn.util/users/jeggert/learnConfigs/spultra.properties
# (2/2) Windows
...
# Uncomment the one for your OS and comment out the other one.
# (1/2) Other than Windows
ln -sf $GRADLE_STAGE/gradle.ultra.properties ~/.gradle/gradle.properties
